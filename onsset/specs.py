...
# Climate configuration constants now live with the modules that consume them:
#   - Common columns (lat/lon/date/admin3) and the sheet name: climate_algorithm.py
#   - Per-hazard parameters: climate_calculations/<hazard>_calculation.py CONFIG_SCHEMA
# Adding a new hazard is a one-file change in climate_calculations/.
